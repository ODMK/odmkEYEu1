...
gorgulan11 = spm.imread(srcDir+'gorgulan0011.jpg')


green_hue = (180-78)/360.0
red_hue = (180-180)/360.0

gorgulanRed = shift_hue(gorgulan11, green_hue)

eyeHueFull = srcDir+'eyeHue.jpg'
misc.imsave(eyeHueFull, gorgulanRed)

# b = spm.imread(imgDir+'gorgulan0012.jpg')
